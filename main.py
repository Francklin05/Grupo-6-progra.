...
integrantes = ["- Delsi cueva Guerra", "- Harriet Mamani Mamani",
                 "- Angelica Perez Poma", "- Francklin Dueñas Lagua"]
...
with st.container():
    ...
    with left_column:
        ...
        st.write(
            """
           Gestionar, contribuyendo la proteccion del medio ambiente y mejora de la calidad de vida de la poblacion. 
            """
